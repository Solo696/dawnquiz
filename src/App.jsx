      ...
      <div style={{ padding: "1.25rem" }}>
        ...
        <div style={{ display: "flex", gap: "0.4rem", marginBottom: "1.25rem" }}>
          {([["questions","❓ Questions"],["announcements","📢 Announce"],["archive","📋 Archive"],
            ...
            ["labels","✏️ Labels"],["reports","⚑ Reports"],["feedback","💬 Feedback"],["admins","👥 Admins"]]).map(([k, l]) => (
    ...
    <div style={css.screen}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginBottom: "1rem", position: "relative" }}>
          <DawnLogo height={26} />
          <div style={{ position: "absolute", right: 0, display: "flex", gap: "0.35rem" }}>
            {onShowWelcome && (
              <button onClick={onShowWelcome} title="How to play" style={{ background: "none", border: `1px solid #f9731633`, borderRadius: 20, padding: "0.2rem 0.55rem", color: "#f97316aa", fontSize: "0.68rem", cursor: "pointer", fontFamily: "inherit" }}>Guide</button>
            )}
            {onAbout && (
              <button onClick={onAbout} title="About DawnQuiz" style={{ background: "none", border: `1px solid ${T.border}`, borderRadius: 20, padding: "0.2rem 0.55rem", color: T.textMuted, fontSize: "0.68rem", cursor: "pointer", fontFamily: "inherit" }}>About</button>
            )}
          </div>
        </div>
        {player.username && (

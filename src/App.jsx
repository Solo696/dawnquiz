...
function StatsAdmin() {
  ...
  if (loading) return (
    <div style={{ padding: "2rem 0", textAlign: "center", color: T.textMuted, fontSize: "0.85rem" }}>Loading stats…</div>
  );
  if (error) return (
    <div style={{ color: T.red, fontSize: "0.8rem", padding: "1rem 0" }}>{error}</div>
  );
  if (!data) return null;
